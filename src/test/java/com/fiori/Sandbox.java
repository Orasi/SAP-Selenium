   ...
   // @Title("Login - Login with correct information")
    ...
    public void testLogin() {
    	...
    	*/
    	...
    	TestReporter.assertTrue(salesOrderPage.customerLoaded("Berlin"),"Loaded Customer to Sales Order Page successfully");
    	salesOrderPage.showProducts();
    	salesOrderPage.selectItemByName("Sunny Sunny", "REA Printer with battery");    	
